...
namespace GeradorDeRotas.Controllers
{
    ...
    {
        private readonly GeradorDeRotasContext _context;

        public EquipesController(GeradorDeRotasContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Codigo")] Equipe equipe)
        {
            if (id != equipe.Id)
            {
                return NotFound();
